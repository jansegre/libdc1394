 ...
 * No Docs
 */
static dc1394error_t dc1394_get_register (dc1394camera_t *camera,
 ...
 * No Docs
 */
static dc1394error_t dc1394_set_register (dc1394camera_t *camera,
                                                 uint64_t offset, uint32_t value)
{
 ...
 * No Docs
 */
static dc1394error_t dc1394_get_control_register (dc1394camera_t *camera,
    uint64_t offset, uint32_t *value)
{
 ...
 * No Docs
 */
static dc1394error_t dc1394_set_control_register (dc1394camera_t *camera,
    uint64_t offset, uint32_t value)
{
